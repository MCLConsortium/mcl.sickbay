...
def addTestData(session):
    ...
    o2 = ProstateOrgan(
        ...
        location_dominant_nodule='left',
        location_secondary_nodule='right or whatever',
        local_extent=AJCCLocalExtent.extraprostataic_extension,
        location_extent_extraprostatic_extension='left or sigh',
        margins=MarginalStatus.negative,
        location_nature_positive_margins='no one cares',
        summed_length_positive_margin='97 or so',
        highest_grade_at_margin=34567,
        seminal_vesicle_invasion='left',
    ...
    o3 = ProstateOrgan(
        ...
        location_dominant_nodule='left again',
        location_secondary_nodule='no one cares',
        local_extent=AJCCLocalExtent.organ_confined,
        location_extent_extraprostatic_extension='no one uses this',
        margins=MarginalStatus.positive,
        location_nature_positive_margins='this never gets used',
        summed_length_positive_margin='even more',
        highest_grade_at_margin=12345,
        seminal_vesicle_invasion='middle yes I said middle',
    ...
    lung = LungOrgan(
        ...
        primary_adenocarcinoma_differentiation_type='Nuts to this',
        ...
        prior_malignancy=PolarAnswer.yes,
        prior_treatment='hormones or some stuff'
    )
